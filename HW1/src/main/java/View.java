...
public class View {
  ...
  public void init(GLAutoDrawable gla) throws Exception {
    ...
    character = new SingleChar(250, 125, gl, program, shaderLocations, "char1");
  }
  ...
  public void draw(GLAutoDrawable gla) {
    ...
    character.draw(gla, (Utility.getHour() * 3600 + Utility.getMin() * 60 + Utility.getSec()) % 36);
    gl.glFlush();
    //disable the program
