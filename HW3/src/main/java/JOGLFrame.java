...
public class JOGLFrame extends JFrame {
  ...
  private class ConfigurationReader {
    ...
    private float[] cameraPosition, centerPosition;
    private int mode;
    ...
    ConfigurationReader(String configPath) {
      this.cameraPosition = new float[]{0, 0, 500};
      this.centerPosition = new float[]{0, 0, 0};
      ...
      while (scanner.hasNext()) {
        ...
        switch (attribution) {
          ...
          case "mode":
            ...
            break;
          case "position":
            cameraPosition[0] = scanner.nextFloat();
            cameraPosition[1] = scanner.nextFloat();
            cameraPosition[2] = scanner.nextFloat();
            break;
          case "orientation":
            this.orientation = scanner.nextInt();
            break;
          case "center":
            centerPosition[0] = scanner.nextFloat();
            centerPosition[1] = scanner.nextFloat();
            centerPosition[2] = scanner.nextFloat();
            break;
        }
      }
    }
    ...
    void applyConfig(View view, GLAutoDrawable glAutoDrawable) throws Exception {
      ...
      System.arraycopy(cameraPosition, 0, camera, 0, camera.length);
      System.arraycopy(centerPosition, 0, center, 0, center.length);
      view.setCameraPosition(camera);
